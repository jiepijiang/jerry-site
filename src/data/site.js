...
export const timeline = [
   ...
   * ⚠️ 这条的日期是**推断的**，不是查到的。
   *
   * 它标的其实是「自有仓库活动的断点」：最后一次 push 是 `news_admin`
   * 2023-01-06，之后到 2025-07 才再有动静（中间 2023-09-05 只有一次
   * fork，不算自己写的项目）。断档约 2 年 9 个月 ——
   * 之前这里写「断了近三年」，略夸大，2026-09-20 核对后改准。
   *
   * 推断这段时间在做嵌入式前端，但**没有公开痕迹可查**（工作仓库是私有的），
   * 所以这条只能等 Jerry 确认或改成真实时间。
   *
